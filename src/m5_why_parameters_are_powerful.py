...
def main():
    ...
    # -------------------------------------------------------------------------
    even_better_draw_circles(rg.Point(-100, 200), 2, 30, 'red', 1)
    even_better_draw_circles(rg.Point(100, 200), 2, 30, 'blue', 1)
    even_better_draw_circles(rg.Point(0, 0), 4, 50, 'green', 2)
...
def better_draw_circles(point, factor):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(factor * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, factor, amount, color, thickness):
